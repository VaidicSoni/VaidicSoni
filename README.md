...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:wse11@txstate.edu)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/VaidicSoni)
---
...
**🎨 Brush** - iOS Drawing Social App
- Built with Swift, Firebase, and Metal for real-time friend drawing feeds
- Implemented 24-hour window functionality with Firestore query filters

**🌤️ Weather Anytime** - Weather Application
- Python-based app with OpenWeather API integration
- Features location-based search and dynamic emoji UI

**🛒 MagiCart** - Grocery Price Comparison Engine *(Google Maps Platform Silver Prize)*
- TypeScript, Firebase, Supabase with Google Maps API integration
- Optimized query latency by ~30% through serverless functions
